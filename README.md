...
[![Release](https://img.shields.io/github/v/release/latest-debs/just-debian)](https://github.com/latest-debs/just-debian/releases)
[![Build](https://github.com/latest-debs/just-debian/actions/workflows/release.yml/badge.svg)](../../actions)
...
For issues with just itself, see
[casey/just](https://github.com/casey/just).

## License

Packaging scripts in this repo are MIT-licensed. The packaged binaries
remain under their upstream license (`CC0-1.0` — see
[casey/just](https://github.com/casey/just)).
